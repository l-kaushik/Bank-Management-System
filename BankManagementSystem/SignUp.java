...
public class SignUp extends JFrame implements ActionListener{
    ...
    SignUp() {
        ...
        pinTextField = Common.CreateTextField(RalewayBold14, new Rectangle(300, 640, 400, 30));
        add(pinTextField);

        // show and get state name
        JLabel stateLabel = Common.CreateLabel("State: ", RalewayBold20, new Rectangle(100, 590, 200, 30));
        add(stateLabel);
